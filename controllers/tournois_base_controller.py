...
from views.menu_rapport import MenuRapport
...
class BaseTournoisController():
    ...
    def recup_choice_to_play(self,tournoi_choice):
        ...
        choice = MenuRapport().menu_option_tournoi()
        if choice == 1:
            self.list_player_tournament_alpha(tournoi_choice)
        elif choice == 2:
            self.list_player_tournament_ranking()
        elif choice == 3:
            self.list_tour_in_tournament()
        elif choice == 4:
            self.list_match_in_tournament()
        elif choice == 5:
