...
class ViewMatchs():
    ...
    def indicate_results(joueur1, joueur2, couleur_joueur1, couleur_joueur2):
        ...
        print(f" Rentrez les résultats du match entre  {joueur1['prenom']}  {joueur1['nom_de_famille']} (couleur jouée : {couleur_joueur1}) et {joueur2['prenom']} {joueur2['nom_de_famille']} (couleur jouée : {couleur_joueur2}): ")
